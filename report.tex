...
A diagram of the model is provided in figures \ref{fig:init_diagram}, \ref{fig:model_diagram}, \ref{fig:end_diagram} and \ref{fig:aux_diagram}
...
The model purpose differs from the system purpose. We aim to predict the consequences of the environmental conditions on the performance of the runners. The model will help us understand how the humidity, heat, and other variables affects the performance of the runners.
