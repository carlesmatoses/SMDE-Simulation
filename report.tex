...
\begin{itemize}
    \item \textbf{SH\_01}: The runners will keep a constant speed over the race.
    \item \textbf{SH\_02}: The runners be spleeted in three groups based on the first 5 kilometters performance.
\end{itemize}
